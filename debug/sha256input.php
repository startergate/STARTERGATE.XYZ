...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../donote/css/style2.css?ver=66">
  	<link rel="stylesheet" type="text/css" href="../donote/css/master.css">
    <link rel="stylesheet" href="/bootstrap-4.0b/css/bootstrap.min.css">
  	<link rel="stylesheet" type="text/css" href="../donote/css/bg_style.css?ver=8">
  ...
  <body id="bge">
    <div class="covra2">
      ...
      <div id=lotext>
        <br />
        <h3><strong>DEBUG - SHA256</strong></h3>
        <br />
        <form id='form' action="./sha256output.php" method="post">
